...
export default function ForgetPassword(){
    ...
    async function changePassword(){
        ...
        try{
            ...
            toast.success("Password changed successfully. Please login with your new pasword.")
            navigate("/login")
    ...
    return(
        <div className="w-full h-screen flex justify-center items-center bg-[url('/bg.jpg')] bg-cover bg-center">
            ...
            {step == "otp" && <div className="w-[400px] backdrop-blur-lg rounded-2xl flex flex-col justify-center items-center p-6 ">
                ...
                <input type="password" value={confirmPassword} onChange={(e)=> setConfirmPassword(e.target.value)} placeholder="Confirm new password" className="w-full text-white p-3 rounded-lg border border-secondary/20 mb-4 focus:outline-none focus:ring-2 focus:ring-accent"/>
